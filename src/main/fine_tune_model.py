from src.training.training_utils import print_summary, eval_and_save_metrics, load_model_trainer, load_bertscore, \
    load_data, create_data_collator, setup_training_env
...
def main(args):
    ...
    trainer = load_model_trainer(base_model_id, bnb_config, compute_bertscore, data_collator, train_data, val_data)
